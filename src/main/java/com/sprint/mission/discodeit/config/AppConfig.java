...
public class AppConfig {
    ...
    public UserService userService(UserRepository userRepository) {
        return new FileUserService(userRepository);
    }

    @Bean
    public ChannelService channelService(ChannelRepository channelRepository) {
        return new FileChannelService(channelRepository);
    }
    ...
    public MessageService messageService(
        ...
        return new FileMessageService(messageRepository, userService, channelService);
    }
}
